...
class LoginFaceIdUseCase extends UseCase<UserDataModel,String>{
  final AuthRepo authRepo;

  LoginFaceIdUseCase(this.authRepo);
  @override
  Future<Either<Failure, UserDataModel>> call([String? param]) {
    return authRepo.loginFaceId(param!);
  }
}