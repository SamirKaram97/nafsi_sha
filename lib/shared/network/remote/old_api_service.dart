...
//   };
//
//   static final InternetConnectionChecker internetConnectionChecker = InternetConnectionChecker.instance;
//
...
//     UserDataModel userModel = UserDataModel.fromJson(response.data["user"]);
...
//
//
//   static Future<UserDataModel> getUserData(context)async
//   {
...
//   }
//
//   static Future<UserDataModel> loginGoogleFacebook(String email, String uId) async {
//
...
//
//
//   static Future<UserDataModel> loginFaceId(String faceId) async {
...
//
//
//   static Future<UserDataModel> updateMe(Map<String,dynamic> values,context)async
//   {
//     String? token = BlocProvider.of<AppCubit>(context).token;
//     if (token != null) {
//       print("token is $token");
...
//         data: values);
//     print(response.data["updatedUser"]);
//     print("from update");
//     UserDataModel userModel = UserDataModel.fromJson(response.data["updatedUser"]);
//     print(response.headers);
//      userModel.token = AppCubit.get(context).token;
//     return userModel;
//   }
//
//   static Future<UserDataModel> updateMeWithFaceId(String faceId,context)async
//   {
//     String? token = BlocProvider.of<AppCubit>(context).token;
//     if (token != null) {
//       print("token is $token");
...
//
//
//   static Future<UserDataModel> getMe(context)async
//   {
//     String? token = BlocProvider.of<AppCubit>(context).token;
//     if (token != null) {
//       _dio.options.headers.addAll({"Cookie": "accessToken=$token"});
